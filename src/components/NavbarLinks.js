...
function NavbarLinks() {
  return (
    <Navbar className="Navbar"  expand="lg">
      <Navbar.Brand href="#home"><i className="fas fa-microphone-alt"></i></Navbar.Brand>
      <Navbar.Toggle aria-controls="basic-navbar-nav" />
      <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="mr-auto">
          <Nav.Link target="_blank" href="https://github.com/pjachimowski/my-artist-ranker">Repo</Nav.Link>
